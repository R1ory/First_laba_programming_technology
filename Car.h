...
public:
    ...
    void setCities(const std::string *cities, int amount_points);

    void setHoursDelivery(const float *hours_delivery, int amount_points);

    void setCargoVolumes(const float *cargo_volumes, int amount_points);
};
